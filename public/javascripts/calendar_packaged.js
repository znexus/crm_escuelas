var configAutoRollOver=true;function dateBocksKeyListener(event){var keyCode=event.keyCode?event.keyCode:event.which?event.which:event.charCode;if(keyCode==13||keyCode==10){return false;}}
...
return true;}
function getDateObj(yyyy,mm,dd,hh,min,ss){var obj=new Date();if(!hh)hh=0;if(!min)min=0;if(!ss)ss=0;obj.setDate(1);obj.setYear(yyyy);obj.setMonth(mm);obj.setDate(dd);obj.setHours(hh);obj.setMinutes(min);obj.setSeconds(ss);return obj;}
var dateParsePatterns=[{re:/^tod|now/i,handler:function(){return new Date();}},{re:/^tom/i,handler:function(){var d=new Date();d.setDate(d.getDate()+1);return d;}},{re:/^yes/i,handler:function(){var d=new Date();d.setDate(d.getDate()-1);return d;}},{re:/^(\d{1,2})(st|nd|rd|th)?$/i,handler:function(bits,calendarIfFormat){var d=new Date();var yyyy=d.getFullYear();var dd=parseInt(bits[1],10);var mm=d.getMonth();if(DateInRange(yyyy,mm,dd))
return getDateObj(yyyy,mm,dd);}},{re:/^(\d{1,2})(?:st|nd|rd|th)? (?:of\s)?(\w+)$/i,handler:function(bits,calendarIfFormat){var d=new Date();var yyyy=d.getFullYear();var dd=parseInt(bits[1],10);var mm=parseMonth(bits[2]);if(DateInRange(yyyy,mm,dd))
return getDateObj(yyyy,mm,dd);}},{re:/^(\d{1,2})(?:st|nd|rd|th)? (?:of )?(\w+),? (\d{4})$/i,handler:function(bits,calendarIfFormat){var d=new Date();d.setDate(parseInt(bits[1],10));d.setMonth(parseMonth(bits[2]));d.setYear(bits[3]);return d;}},{re:/^(\w+) (\d{1,2})(?:st|nd|rd|th)?$/i,handler:function(bits,calendarIfFormat){var d=new Date();var yyyy=d.getFullYear();var dd=parseInt(bits[2],10);var mm=parseMonth(bits[1]);if(DateInRange(yyyy,mm,dd))
return getDateObj(yyyy,mm,dd);}},{re:/^(\w+) (\d{1,2})(?:st|nd|rd|th)?,? (\d{4})$/i,handler:function(bits,calendarIfFormat){var yyyy=parseInt(bits[3],10);var dd=parseInt(bits[2],10);var mm=parseMonth(bits[1]);if(DateInRange(yyyy,mm,dd))
return getDateObj(yyyy,mm,dd);}},{re:/((next|last)\s(week|month|year))/i,handler:function(bits,calendarIfFormat){var objDate=new Date();var dd=objDate.getDate();var mm=objDate.getMonth();var yyyy=objDate.getFullYear();switch(bits[3]){case'week':var newDay=(bits[2]=='next')?(dd+7):(dd-7);objDate.setDate(newDay);break;case'month':var newMonth=(bits[2]=='next')?(mm+1):(mm-1);objDate.setMonth(newMonth);break;case'year':var newYear=(bits[2]=='next')?(yyyy+1):(yyyy-1);objDate.setYear(newYear);break;}
return objDate;}},{re:/^next (\w+)$/i,handler:function(bits,calendarIfFormat){var d=new Date();var day=d.getDay();var newDay=parseWeekday(bits[1]);var addDays=newDay-day;if(newDay<=day){addDays+=7;}
d.setDate(d.getDate()+addDays);return d;}},{re:/^last (\w+)$/i,handler:function(bits,calendarIfFormat){var d=new Date();var wd=d.getDay();var nwd=parseWeekday(bits[1]);var addDays=(-1*(wd+7-nwd))%7;if(0==addDays)
addDays=-7;d.setDate(d.getDate()+addDays);return d;}},{re:/(\d{1,2})\/(\d{1,2})\/(\d{4})/,handler:function(bits,calendarIfFormat){if(calendarIfFormat[1]=='d'){var yyyy=parseInt(bits[3],10);var dd=parseInt(bits[1],10);var mm=parseInt(bits[2],10)-1;}else{var yyyy=parseInt(bits[3],10);var dd=parseInt(bits[2],10);var mm=parseInt(bits[1],10)-1;}
if(DateInRange(yyyy,mm,dd))
return getDateObj(yyyy,mm,dd);}},{re:/(\d{1,2})\/(\d{1,2})\/(\d{1,2})/,handler:function(bits,calendarIfFormat){var d=new Date();var yyyy=d.getFullYear()-(d.getFullYear()%100)+parseInt(bits[3],10);var dd=parseInt(bits[2],10);var mm=parseInt(bits[1],10)-1;if(DateInRange(yyyy,mm,dd))
return getDateObj(yyyy,mm,dd);}},{re:/(\d{1,2})\/(\d{1,2})/,handler:function(bits,calendarIfFormat){var d=new Date();var yyyy=d.getFullYear();var dd=parseInt(bits[2],10);var mm=parseInt(bits[1],10)-1;if(DateInRange(yyyy,mm,dd))
return getDateObj(yyyy,mm,dd);}},{re:/(\d{1,2})-(\d{1,2})-(\d{4}) (\d{1,2}):(\d{1,2}):(\d{1,2})/,handler:function(bits,calendarIfFormat){if(calendarIfFormat[1]=='d'){var yyyy=parseInt(bits[3],10);var dd=parseInt(bits[1],10);var mm=parseInt(bits[2],10)-1;}else{var yyyy=parseInt(bits[3],10);var dd=parseInt(bits[2],10);var mm=parseInt(bits[1],10)-1;}
var hh=parseInt(bits[4],10);var min=parseInt(bits[5],10);var ss=parseInt(bits[6],10);if(DateInRange(yyyy,mm,dd)){return getDateObj(yyyy,mm,dd,hh,min,ss);}}},{re:/(\d{1,2})-(\d{1,2})-(\d{4})/,handler:function(bits,calendarIfFormat){if(calendarIfFormat[1]=='d'){var yyyy=parseInt(bits[3],10);var dd=parseInt(bits[1],10);var mm=parseInt(bits[2],10)-1;}else{var yyyy=parseInt(bits[3],10);var dd=parseInt(bits[2],10);var mm=parseInt(bits[1],10)-1;}
if(DateInRange(yyyy,mm,dd)){return getDateObj(yyyy,mm,dd);}}},{re:/(\d{1,2})\.(\d{1,2})\.(\d{4}) (\d{1,2}):(\d{1,2}):(\d{1,2})/,handler:function(bits,calendarIfFormat){var dd=parseInt(bits[1],10);var mm=parseInt(bits[2],10)-1;var yyyy=parseInt(bits[3],10);var hh=parseInt(bits[4],10);var min=parseInt(bits[5],10);var ss=parseInt(bits[6],10);if(DateInRange(yyyy,mm,dd))
return getDateObj(yyyy,mm,dd,hh,min,ss);}},{re:/(\d{1,2})\.(\d{1,2})\.(\d{4})/,handler:function(bits,calendarIfFormat){var dd=parseInt(bits[1],10);var mm=parseInt(bits[2],10)-1;var yyyy=parseInt(bits[3],10);if(DateInRange(yyyy,mm,dd))
return getDateObj(yyyy,mm,dd);}},{re:/(\d{4})-(\d{1,2})-(\d{1,2}) (\d{1,2}):(\d{1,2}):(\d{1,2})/,handler:function(bits,calendarIfFormat){var yyyy=parseInt(bits[1],10);var dd=parseInt(bits[3],10);var mm=parseInt(bits[2],10)-1;var hh=parseInt(bits[4],10);var min=parseInt(bits[5],10);var ss=parseInt(bits[6],10);if(DateInRange(yyyy,mm,dd))
return getDateObj(yyyy,mm,dd,hh,min,ss);}},{re:/(\d{4})-(\d{1,2})-(\d{1,2})/,handler:function(bits,calendarIfFormat){var yyyy=parseInt(bits[1],10);var dd=parseInt(bits[3],10);var mm=parseInt(bits[2],10)-1;if(DateInRange(yyyy,mm,dd))
return getDateObj(yyyy,mm,dd);}},{re:/(\d{1,2})-(\d{1,2})-(\d{1,2})/,handler:function(bits,calendarIfFormat){var d=new Date();var yyyy=d.getFullYear()-(d.getFullYear()%100)+parseInt(bits[1],10);var dd=parseInt(bits[3],10);var mm=parseInt(bits[2],10)-1;if(DateInRange(yyyy,mm,dd))
return getDateObj(yyyy,mm,dd);}},{re:/(\d{1,2})-(\d{1,2})/,handler:function(bits,calendarIfFormat){var d=new Date();var yyyy=d.getFullYear();var dd=parseInt(bits[2],10);var mm=parseInt(bits[1],10)-1;if(DateInRange(yyyy,mm,dd))
return getDateObj(yyyy,mm,dd);}},{re:/(^mon.*|^tue.*|^wed.*|^thu.*|^fri.*|^sat.*|^sun.*)/i,handler:function(bits,calendarIfFormat){var d=new Date();var day=d.getDay();var newDay=parseWeekday(bits[1]);var addDays=newDay-day;if(newDay<=day){addDays+=7;}
d.setDate(d.getDate()+addDays);return d;}},];function parseDateString(s,calendarIfFormat){for(var i=0;i<dateParsePatterns.length;i++){var re=dateParsePatterns[i].re;var handler=dateParsePatterns[i].handler;var bits=re.exec(s,calendarIfFormat);if(bits){return handler(bits,calendarIfFormat);}}
throw new Error("Invalid date string");}
function magicDateOnlyOnSubmit(id,calendarIfFormat,event){var keyCode=event.keyCode?event.keyCode:event.which?event.which:event.charCode;if(keyCode==13||keyCode==10){magicDate(id,calendarIfFormat);}}
function magicDate(id,calendarIfFormat){var input=document.getElementById(id);var messagespan=input.id+'Msg';try{var d=parseDateString(input.value,calendarIfFormat);var year=d.getFullYear();var day=(d.getDate()<=9)?'0'+d.getDate().toString():d.getDate();var month=((d.getMonth()+1)<=9)?'0'+(d.getMonth()+1):(d.getMonth()+1);var hours=(d.getHours()<=9)?'0'+d.getHours().toString():d.getHours();var minutes=(d.getMinutes()<=9)?'0'+d.getMinutes().toString():d.getMinutes();var seconds=(d.getSeconds()<=9)?'0'+d.getSeconds().toString():d.getSeconds();if(calendarIfFormat){date_value=calendarIfFormat.replace("%Y",year).replace("%m",month).replace("%d",day).replace("%H",hours).replace("%M",minutes).replace("%S",seconds);}
else{date_value=year+'-'+month+'-'+day;}
input.value=date_value;if(document.getElementById(messagespan))document.getElementById(messagespan).innerHTML=d.toDateString();if(document.getElementById(messagespan))document.getElementById(messagespan).className='normal';}
catch(e){input.className='fieldWithErrors';var message=e.message;if(message.indexOf('is null or not an object')>-1){message='Invalid date string';}
if(document.getElementById(messagespan))document.getElementById(messagespan).innerHTML=message;if(document.getElementById(messagespan))document.getElementById(messagespan).className='error';}}
...
if(Calendar.is_ie7){br.y+=window.scrollY;br.x+=window.scrollX;}else{br.y+=document.body.scrollTop;br.x+=document.body.scrollLeft;}
